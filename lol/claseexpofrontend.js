class _Expo{
	constructor(
	_id, NOMBRE, MIEMBRO1, MIEMBRO2, MIEMBRO3, GRADO, TEMATICA, DESCRIPCION, IMAGEN){
	this._id=_id;
	this.NOMBRE=NOMBRE;
    ...
    // Do the usual XHR stuff
      ...
      try {
       ...
       var xhr = new XMLHttpRequest();
        xhr.open('POST', 'http://localhost:8080/api/Nuevoproyecto');
  ...
  return new Promise(function(resolve, reject) {
    // Do the usual XHR stuff
      ...
      try {
               ...
               var xhr = new XMLHttpRequest();
xhr.open('POST', 'http://localhost:8080/api/Modificaproyecto');
xhr.setRequestHeader('Content-Type', 'application/json');
xhr.onload = function() {
    if (xhr.status === 200) {
        resolve(JSON.parse(xhr.responseText));
  ...
  return new Promise(function(resolve, reject) {
    // Do the usual XHR stuff
      ...
      try {
               ...
               var xhr = new XMLHttpRequest();
xhr.open('POST', 'http://localhost:8080/api/Eliminaproyecto');
xhr.setRequestHeader('Content-Type', 'application/json');
xhr.onload = function() {
    if (xhr.status === 200) {
        resolve(JSON.parse(xhr.responseText));
  ...
  return new Promise(function(resolve, reject) {
    // Do the usual XHR stuff
      ...
      try {
               ...
               var xhr = new XMLHttpRequest();
xhr.open('POST', 'http://localhost:8080/api/seleccionarportematica');
xhr.setRequestHeader('Content-Type', 'application/json');
xhr.onload = function() {
    if (xhr.status === 200) {
        resolve(JSON.parse(xhr.responseText));
